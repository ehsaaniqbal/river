...
const advancedCO = new Set([...intermediateCO, ...(ADVANCED_MIXED_HANDS.CO ?? new Set<string>())]);
const advancedBTN = new Set([...intermediateBTN, ...(ADVANCED_MIXED_HANDS.BTN ?? new Set<string>())]);
const advancedSB = new Set([...intermediateCO, ...(ADVANCED_MIXED_HANDS.SB ?? new Set<string>())]);
