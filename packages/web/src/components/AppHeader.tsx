...
export function AppHeader() {
  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-4 z-50 flex justify-center px-4">
      <nav className="liquid-glass liquid-highlight pointer-events-auto flex h-12 w-full max-w-[38rem] items-center justify-between rounded-xl px-2 text-sm text-emerald-50/72">
        <Link
          href="/"
